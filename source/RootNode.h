...
public:
    ...
    RootNode(SDL_Renderer* renderer_in = nullptr, Node* parentNode_in = nullptr): Node(renderer_in, parentNode_in)
    {
        ...
        // // make a simple text button that will take you to the game node
        // SimpleButton* gameButton = createSimpleTextButton(renderer_in, "fonts/pixel/classic.ttf", 30, "PLAY SIMPLE GAME", 255, 0, 0);
        // gameButton->setButtonPosition(windowWidth / 2 - gameButton->getWidth() / 2,
        //                               mainMenuText->getY() + mainMenuText->getH() + 50);
        // // link this button to the gameNode by creating an action and passing the gameNode pointer as the action parameter
        // //gameButton->setButtonAction(createAction(MOVE_NODES, gameNode));
       
        // HIGHSCORES BUTTON
        // make a simple text button that will take you to the highscores node
        ...
        // GAME MENU BUTTON
        // make a simple text button that will take you to the gameMenu node
        ...
        // OPTIONS BUTTON
        // make a simple text button that will take you to the options node
        ...
        //===================rootNodeScreen->addButtonToScreen(gameButton);
